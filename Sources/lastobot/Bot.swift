...
class Bot {
    let welcomeText = """
                      ...
                      4) Чтобы создать новую игру, Ведущему в беседе со мной нужно нажать на кнопку "начать игру" или воспользоваться командой /startgame. После этого Ведущий получит id игры, который нужно раздать капитанам команд для присоединения к сессии игры.
